...
const experiments = [
  ...
  {
    title: "Casper Wallet",
    medium: "Signature Points",
    description: "Wallet pops up 5 times total: 1 setup + 4 recovery signatures.",
  ...
  {
    title: "Key Rotation",
    medium: "Phase 2 - Execute",
    description: "Backend submits after 30 days. Removes old key, adds new key. No user signature needed.",
    ...
    <section ref={sectionRef} id="work" className="relative py-32 pl-6 md:pl-28 pr-6 md:pr-12">
      ...
      <div ref={headerRef} className="mb-16 flex items-end justify-between">
        ...
        <p className="hidden md:block max-w-xs font-mono text-xs text-muted-foreground text-right leading-relaxed">
          Distributed trust, 30-day safety period, and automated key rotation on Casper Network.
        </p>
      </div>
