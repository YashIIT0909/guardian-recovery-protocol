...
export function PrinciplesSection() {
  ...
  const principles = [
    ...
    },
    {
      ...
      description: "30-day waiting period after all approvals. Cancel recovery if you find your old key.",
      align: "right",
    },
    {
      number: "03",
      titleParts: [
        ...
        { text: "SIGNATURES", highlight: true },
      ],
      description: "Casper Wallet signs 5 times total: 1 setup + 4 recovery (Alice + 3 friends).",
      align: "left",
    },
    {
      number: "04",
      titleParts: [
        { text: "AUTOMATED ", highlight: false },
        { text: "EXECUTION", highlight: true },
      ],
      description: "Backend executes key rotation after 30 days using collected signatures. No additional user action needed.",
      align: "right",
    },
  ]
  ...
  return (
    <section ref={sectionRef} id="principles" className="relative py-32 pl-6 md:pl-28 pr-6 md:pr-12">
      ...
      <div ref={headerRef} className="mb-24">
        ...
        <h2 className="mt-4 font-[var(--font-bebas)] text-5xl md:text-7xl tracking-tight">CORE PRINCIPLES</h2>
      </div>
