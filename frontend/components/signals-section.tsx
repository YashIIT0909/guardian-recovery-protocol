...
const signals = [
  ...
  },
  {
    ...
    note: "Backend submits with collected signatures. Old key removed, new key added. Account recovered.",
  },
  {
    date: "STATUS",
  ...
  return (
    <section id="signals" ref={sectionRef} className="relative py-32 pl-6 md:pl-28">
      ...
      <div ref={headerRef} className="mb-16 pr-6 md:pr-12">
        <span className="font-mono text-[10px] uppercase tracking-[0.3em] text-accent">01 / Workflow</span>
